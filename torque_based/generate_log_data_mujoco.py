...
def apply_command(kp, kd, q_des, dq_des, tau_ff, steps_window=10):
    ...
    q_f = q_des # target positions
    torque_f = cmd_torques # final commanded torques
    
    return (q_0, dq_0, q_f, torque_f)
...
for t in range(num_steps):
    ...
    q_0, dq_0, q_f, torque_f = apply_command(kp, kd, q_des, dq_des, tau_ff)
    cur_log_data = {
    "joint_pos": q_0,
    "joint_vel": dq_0,
    "joint_pos_next": q_f,
    "joint_torque_next": torque_f
    }
